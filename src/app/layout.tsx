...
export const metadata: Metadata = {
  ...
  description: "Production-ready Next.js boilerplate for building AI-powered SaaS applications. Features authentication, API rate limiting, Stripe integration, and more.",
  keywords: [
    "AI SaaS",
    "Next.js",
    "React",
